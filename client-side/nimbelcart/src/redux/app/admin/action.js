...
export const GET_ADMIN_DATA = () => (dispatch) => {
  ...
  return axios
    .get(ADMIN_URL)
    .then((res) => {
      dispatch(GET_ADMIN_DATA_SUCESS_fn(res.data));
    })
    .catch((err) => {
      dispatch(
        GET_ADMIN_DATA_FAILURE_fn({ Error: "SomeThing Went Wrong", err })
      );
    });
};
...
export const ADD_ADMIN_DATA = (payload) => (dispatch) => {
  ...
  return axios
    ...
    .catch((err) => {
      dispatch(
        ADD_ADMIN_DATA_FAILURE_fn({ Error: "SomeThing Went Wrong", err })
      );
    });
};
...
export const EDIT_ADMIN_DATA = (id, payload) => (dispatch) => {
  ...
  return axios
    .patch(`https://nyresa-database.vercel.app/Mens/${id}`, payload)
    .then((res) => {
    ...
    .catch((err) => {
      dispatch(
        EDIT_ADMIN_DATA_FAILURE_fn({ Error: "SomeThing Went Wrong", err })
      );
    });
};
...
export const DELETE_ADMIN_DATA = (id) => (dispatch) => {
  ...
  return axios
    ...
    .catch((err) => {
      dispatch(
        DELETE_ADMIN_DATA_FAILURE_fn({ Error: "SomeThing Went Wrong", err })
      );
    });
};
...
export const SEARCH_ADMIN_DATA = (payload) => (dispatch) => {
  ...
  return axios
    .get(ADMIN_URL, payload)
    .then((res) => {
      dispatch(SEARCH_ADMIN_DATA_SUCESS_fn(res.data));
    })
    .catch((err) => {
      dispatch(
        SEARCH_ADMIN_DATA_FAILURE_fn({ Error: "SomeThing Went Wrong", err })
      );
    });
};
